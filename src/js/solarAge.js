export default class SolarAge {
  ...
  WhichPlanet() {
    ...
    if (yearsLeft < 0) {
      answer = `According to our calculations on the planet ${planet} you are ${planetAge} years old. You have exceeded your life span by ${-yearsLeft} years on the planet`;
    } else {
